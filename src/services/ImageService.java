...
public class ImageService {
	...
	// Helper function to load JSON to a JSONArray containing the contents of the image
	...
	private static List<BufferedImage> loadBufferedImagesFromJson(JsonArray jsonArray) {
        ...
        try {
        	// Initially, the image retrieval was done sequentially. However, to meet time constraint, parallelization is required
